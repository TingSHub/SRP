cd /d D:\SRP\SRP
set RTT_ROOT=
set ENV_ROOT=F:/RT-ThreadStudio/platform/env_released/env
set RTT_EXEC_PATH=F:/RT-ThreadStudio/repo/Extract/ToolChain_Support_Packages/ARM/GNU_Tools_for_ARM_Embedded_Processors/5.4.1/bin
